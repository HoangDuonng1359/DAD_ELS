...
public class MultiChoiceGameController extends baseFormController{
    ...
    private void initgame(){
        String[] choice = {"am","is","are","who"};
        Question question = new Question("i ... duo",choice,"am");
        Question question2 = new Question("hello how ... you", new String[]{"is", "am", "are", "who"},"are");
        // import question
        quiz =  new Quiz(List.of(new Question[]{question, question2}));
        setQuestion(quiz);
